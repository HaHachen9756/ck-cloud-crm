package com.ck.cloud.config.mapper;
...
public class GlobalTransactionConfiguration {
    ...
    /**
     * 配置全局事务的切点为 CommandHandler 的所有方法 AOP 切面表达式
     * <p>
     *     参考说明：<a href="https://blog.csdn.net/ycf921244819/article/details/106599489">SpringBoot 之 AoP 切面 execution 表达式</a>
     * </p>
     */
    private static final String POINTCUT_EXPRESSION = "execution(public * com.yuanben.cloud.provider.command..*.*CommandHandler.*(..))";
    ...
    public TransactionInterceptor txAdvice() {
        ...
        txAttrRequired.setName("REQUIRED 事务");

        // 设置事务传播机制，默认是 PROPAGATION_REQUIRED：如果当前存在事务，则加入该事务；如果当前没有事务，则创建一个新的事务
        txAttrRequired.setPropagationBehavior(TransactionDefinition.PROPAGATION_REQUIRED);
        // 设置异常回滚为 Exception 默认是 RuntimeException
        ...
        txAttrRequiredReadOnly.setName("SUPPORTS 事务");
